...
export function useChatWindowMediaOrchestrator(bindings: Record<string, any>) {
  ...
  return {
    ...
    microphonePermissionState: chatMedia.microphonePermissionState,
    microphonePermissionRequesting: chatMedia.microphonePermissionRequesting,
    ...
    requestMicrophonePermission: chatMedia.requestMicrophonePermission,
